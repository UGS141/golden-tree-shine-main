            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  name="state"
                  required
                  className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white"
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Solar For Home/Commercial? *</label>
                <select
                  name="serviceType"
                  required
                  className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white"
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Monthly Average Electricity Bill *</label>
                <select
                  name="monthlyBill"
                  required
                  className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white"
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Interested in Finance? *</label>
                <select
